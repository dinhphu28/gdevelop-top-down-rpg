...
gdjs.OverworldCode.asyncCallback16692132 = function (runtimeScene, asyncObjectsList) {
...
gdjs.OverworldCode.idToCallbackMap.set(16692132, gdjs.OverworldCode.asyncCallback16692132);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.25), (runtimeScene) => (gdjs.OverworldCode.asyncCallback16692132(runtimeScene, asyncObjectsList)), 16692132, asyncObjectsList);
}
}
...
for (var i = 0, k = 0, l = gdjs.OverworldCode.GDDialogBoxObjects3.length;i<l;++i) {
    if ( gdjs.OverworldCode.GDDialogBoxObjects3[i].IsYesClicked(null) ) {
...
{for(var i = 0, len = gdjs.OverworldCode.GDTransitionObjects3.length ;i < len;++i) {
    gdjs.OverworldCode.GDTransitionObjects3[i].getBehavior("FlashTransitionPainter").PaintEffect("0;0;0", 1, "Circular", "Forward", 255, null);
}
}
...
for (var i = 0, k = 0, l = gdjs.OverworldCode.GDDialogBoxObjects2.length;i<l;++i) {
    if ( gdjs.OverworldCode.GDDialogBoxObjects2[i].IsNoClicked(null) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16689460);
}
if (isConditionTrue_0) {
isConditionTrue_0 = false;
